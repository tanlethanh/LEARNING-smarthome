...
context = [
    {
        ...
        'content': "Image you're a polite and friendly assistant in my iot app.\
            Your'name is Tom and you will help me to find result of my request.\
            Try to make response as short as possible, i just want to get main content of the response.\
            It's good to have response shorter than 10 words! Thank you!"
    }
]
        ...
        while 1:
            ...
            if res.get('typ') == "greeting":
                ...
                while 1:
                    ...
                    print("Assistant:{}".format(res.get('res')))
                    speak(res.get('res'))
