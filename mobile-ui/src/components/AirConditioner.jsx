...
function AirConditioner ({ powerState, callback }) {
    ...
    const handleSetPower = (value) => { setPower(value) }
    useEffect(() => {
        setPower(powerState)
    }, [powerState])
    const handleSubmit = () => {
        ...
        <View className="flex flex-col w-full h-full p-3 gap-1 items-center">
            ...
            <View className="flex flex-row justify-center h-[100px] items-start w-full overflow-hidden px-3">
                <View className="flex flex-col items-center justify-center h-full w-[100px]">
                    <TouchableOpacity className="rounded-xl items-center" onPress={handleTogglePower}>
                        <Image className="w-[80px] h-[80px] left-[2.5px]"
                            source={power != 0 ? require('../assets/button-air-on.png') : require('../assets/button-air-off.png')}
                        >
                        </Image>
                        <PowerIcon
                ...
                <View className="flex flex-col items-center justify-center h-full w-[100px]">
                    <TouchableOpacity className="rounded-xl items-center" onPress={handleToggleAuto}>
                        <Image className="w-[80px] h-[80px] left-[2.5px]"
                            source={auto != 0 ? require('../assets/button-air-on.png') : require('../assets/button-air-off.png')}
                        >
                        </Image>
                        <CogIcon
                ...
                <View className="flex flex-col items-center justify-center h-full w-[100px]">
                    <TouchableOpacity className="rounded-xl items-center" onPress={() => { setSchedule(!schedule) }}>
                        <Image className="w-[80px] h-[80px] left-[2.5px]"
                            source={schedule != 0 ? require('../assets/button-air-on.png') : require('../assets/button-air-off.png')}
                        >
                        </Image>
                        <ClockIcon
            ...
            <View className="flex flex-row justify-between h-[95px] items-start w-full overflow-hidden px-3">
                <View className="bg-[#d9d9d9] shadow-md shadow-black w-[110px] h-[80px] items-center justify-center rounded-[20px]">
                    <Text className="font-semibold text-gray-700">Temp Indoor</Text>
                    <Text className="font-bold text-gray-700">{18 + '\u00b0C'}</Text>
                </View>
                <View className="bg-[#d9d9d9] shadow-md shadow-black w-[110px] h-[80px] items-center justify-center rounded-[20px]">
                    <Text className="font-semibold text-gray-700">Temp Out</Text>
                    <Text className="font-bold text-gray-700">{18 + '\u00b0C'}</Text>
                </View>
                <View className="bg-[#d9d9d9] shadow-md shadow-black w-[110px] h-[80px] items-center justify-center rounded-[20px]">
                    <Text className="font-semibold text-gray-700">Wind Speed</Text>
                    <Text className="font-bold text-gray-700">{2 + ' Grade'}</Text>
                </View>
            </View>
            {schedule == 1
                ? <View className="flex flex-col items-center justify-center gap-1">
                    <Button onPress={() => { showDatepicker() }} title="Show time picker!" backgroundColor={'#cccccc'}>Date</Button>
                    <Button onPress={() => { showTimepicker() }} title="Show time picker!" backgroundColor={'#cccccc'}>Time</Button>
