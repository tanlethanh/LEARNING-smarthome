...
const EnergyWidget = (props) => {
    return (
        <Pressable
            className={"h-[106px] w-full rounded-[22px] px-[21px] pt-[16px] pb-[14px] ".concat(
                props.className,
            )}
            style={{
        ...
        >
            <View className="flex flex-row flex-1 justify-between items-center">
                <View className="flex-[2] flex flex-col items-start gap-[5px] ">
                    <Text className="font-[700] text-[14px] text-[#191919]">
                        Energy Saving
                    </Text>
                    <Text className="font-[700]  text-[24px] text-[#15b342]">
                        +35%
                    </Text>
